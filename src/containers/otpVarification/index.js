  ...
  return (
    <div>
      ...
      >
        ...
        <h3 className="font-bold text-background2">Enter OTP</h3>
        <div className="flex flex-col gap-5">
          <div className="relative">
            ...
            <Input
              placeholder="OTP"
              className="p-4 border border-primary3 w-full relative"
            />
            <a href="http://" className="text-primary absolute top-8 right-3">
              Resend OTP
            </a>
          </div>
          <Button
