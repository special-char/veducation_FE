  ...
  return (
    <div className={styles.productItem}>
      ...
      <div className={styles.productItem__desc}>
        ...
        <p className={styles.productItem__author}>{author && `by ${author}`}</p>
        <p className={styles.productItem__author}>{weight && weight}</p>
        <p className={styles.productItem__author}>{content && content}</p>
